    ...
    static class StressTest
        ...
        public void run() {
            ...
            //if (counterValue < repeat)
            {
                ...
                hmciToUse.setAuthorization(HTTPAuthorization.createBearer(jwt.hash(add.getAPIKeyAsBytes(), JWTProvider.SINGLETON)));
...
//    nvg.setName("zip_code_api_config");
    ...
    public static void deleteAppDevice(String url, AppDeviceDAO apd) throws IOException {
        ...
        hmci.setAuthorization(HTTPAuthorization.createBearer(jwt.hash(apd.getAPIKeyAsBytes(), JWTProvider.SINGLETON)));
        HTTPCall hc = new HTTPCall(hmci);
    ...
    public static void renewToken(String url, String subjectID, String password, String domainID,
        ...
        try {
            ...
            String uri = encrypt ? SUS.toCanonicalID('/', XXURI.API_KEY_BASE, XXURI.C_RENEW, XXURI.C_ENCRYPT)
                    : SUS.toCanonicalID('/', XXURI.API_KEY_BASE, XXURI.C_RENEW);
            ...
            hmci.setAuthorization(HTTPAuthorization.createBearer(jwt.hash(add.getAPIKeyAsBytes(), JWTProvider.SINGLETON)));
            HTTPCall hc = new HTTPCall(hmci);
            HTTPResponseData hrd = hc.sendRequest();
    ...
    public static void updateUserRole(String url, String subjectID, String password, String domainID,
        ...
        params.add("app_gid", AppID.toDomainAppID(domainID, appID));
