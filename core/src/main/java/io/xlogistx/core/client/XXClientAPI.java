...
//                    System.out.println("error:" + fails.incrementAndGet());
  ...
  public static AppDeviceDAO createAppDeviceDAO(String domainID, String appID) {
    ...
    ret.setAppGID(new AppIDDAO(domainID, appID).getAppGID());
    return ret;
  }
...
//    nvg.setName("zip_code_api_config");
  ...
  public static AppIDDAO deleteAppID(String url, String subjectID, String password, String domainID,
    ...
    appDeviceDAO.setAppGID(new AppIDDAO(domainID, appID).getAppGID());
    ...
    try {
      ...
      switch (command) {
        ...
        case "renewtoken":
          ...
          break;
        case "createitem":
          AppIDDAO.toAppID(domainID, appID).getAppGID();
          ItemDAO item = createItemDAO(AppIDDAO.toAppID(domainID, appID).getAppGID(), "http://localhost");
